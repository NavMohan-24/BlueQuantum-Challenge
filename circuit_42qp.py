...
qc = qiskit.qasm2.load('circuit_2_42q.qasm', include_path=('.',), include_input_directory='append', custom_instructions=qiskit.qasm2.LEGACY_CUSTOM_INSTRUCTIONS, custom_classical=(), strict=False)
